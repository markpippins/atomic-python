        ...
        <Grid item xs={12} md={4}>
          <Card
            sx={{
              ...
              borderLeft: hasActiveScans ? '3px solid' : '3px solid transparent',
                      ...
                      {scan.current_directory && (
                        <Box sx={{ mb: 1 }}>
                          <Typography variant="caption" color="text.secondary">
                            <strong>Directory:</strong> {scan.current_directory}
                          </Typography>
                        </Box>
                      )}
                      {scan.current_file && (
                        <Box sx={{ mb: 1 }}>
                          <Typography variant="caption" color="text.secondary">
                            <strong>File:</strong> {scan.current_file.split('/').pop() || scan.current_file}
                          </Typography>
                        </Box>
                      )}
